...
from s3 import guardarImagen
from db_admin import readCancionesAlbum, readCancionesArtista
import os

prefijoBucket = os.getenv("https://multimedia-semi1-g9.s3.amazonaws.com/")
